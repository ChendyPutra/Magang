...
<body class="bg-white ">
    ...
    <section class="w-full h-screen bg-white bg-center bg-cover" style="background-image: url('images/pattern.png');">
        <div
            class="container flex flex-col justify-center h-full px-4 pt-10 pb-10 pl-4 pr-4 mx-auto bg-black items-left text-start bg-opacity-30">
    ...
    <section class="w-full h-screen bg-center bg-cover" id="pemasukan"
        style="background-image: url('images/pemasukan.png')">
        ...
        <div class="p-6 bg-white rounded-lg ">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    // Tambah daftar label samping
                    const categoryList = document.getElementById('categoryList');
                    labels.forEach((label, i) => {
                        const percent = total ? ((values[i] / total) * 100).toFixed(2) : 0;
    ...
    <section class="py-8 bg-gray-100">
        <div class="container mx-auto">
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <div class="space-y-4">
                    <form action="{{ route('komentar.store', ['type' => 'pemasukan']) }}" method="POST"
                        class="space-y-4">
                        @csrf
                        <div>
